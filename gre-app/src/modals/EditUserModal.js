          ...
          <Form.Group as={Col} controlId="formGridFile">
            ...
            <Form.Row>
              <Form.Group as={Col} controlId="formType">
                ...
                <Form.Control required onChange={(e) => setUser({...user,tipo: e.target.value})} name="tipo" as="select" defaultValue="Escolher..." value={user.tipo ? user.tipo : user.tipo == "" ? user.tipo : userr.tipo}>
